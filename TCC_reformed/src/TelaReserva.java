...
public class TelaReserva extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtAndar, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 104, Short.MAX_VALUE))
                            .addComponent(txtSobrenome2, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addComponent(btnRegistro2))
                            .addComponent(txtTempo, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
    ...
    private void btnRegistro2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistro2ActionPerformed
        ...
        String sobrenome2 = txtSobrenome2.getText();
        String quarto = txtQuarto.getText();
        String tempo = txtTempo.getText();
        String andar = txtAndar.getText();
        
        PreparedStatement ps;
        String query = "INSERT INTO `reservas_hotel` (`NomeHS`,`SNomeHS`,`QuartoHS`,`AndarHS`,`DiasHS`) VALUES (?,?,?,?,?)";
        
        String query2 = "SELECT * FROM `administrador_hotel` WHERE `Usuario`=? AND `Senha` =?";
        
        try{
            ps = MyConnection.getConnection().prepareStatement(query);
            
            ps.setString(1, nome2);
            ps.setString(2, sobrenome2);
            ps.setString(3, quarto);
            ps.setString(4, tempo);
            ps.setString(5, andar);
